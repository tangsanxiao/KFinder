...
@Test func aggregateGroupsByNameAcrossAgentsAndSorts() {
    let raws = [
        raw(.claude, "/a/zeta", "h1", name: "zeta"),
        raw(.claude, "/a/alpha", "h2", name: "alpha"),
